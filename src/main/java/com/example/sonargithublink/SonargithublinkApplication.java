...
public class SonargithublinkApplication {
    ...
    public static void main(String[] args) {
        ...
        doARandomLongCodedMathOperation();
    }

    private static void doARandomLongCodedMathOperation() {
        //print a very ugly multi line math operation, just to see if sonarcloud will detect it
        ...
        //make it 400 times longer in line count
